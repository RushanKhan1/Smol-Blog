...
mongoose.connect("mongodb+srv://" + process.env.DB_USER + ":" + process.env.DB_PASS + "@cluster0.2zug1.mongodb.net/SmolBlogDB?retryWrites=true&w=majority", {useNewUrlParser: true, useUnifiedTopology: true});
